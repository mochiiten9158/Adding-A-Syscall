  ...
  58:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  5d:	68 f8 05 00 00       	push   $0x5f8
  62:	e8 69 01 00 00       	call   1d0 <strlen>
  67:	83 c4 0c             	add    $0xc,%esp
  6a:	50                   	push   %eax
  6b:	68 f8 05 00 00       	push   $0x5f8
  70:	6a 01                	push   $0x1
  ...
  e2:	68 03 06 00 00       	push   $0x603
  e7:	e8 e4 00 00 00       	call   1d0 <strlen>
  ec:	83 c4 0c             	add    $0xc,%esp
  ef:	50                   	push   %eax
  f0:	68 03 06 00 00       	push   $0x603
  f5:	6a 01                	push   $0x1
 ...
 104:	68 17 06 00 00       	push   $0x617
 109:	e8 c2 00 00 00       	call   1d0 <strlen>
 10e:	83 c4 0c             	add    $0xc,%esp
 111:	50                   	push   %eax
 112:	68 17 06 00 00       	push   $0x617
 117:	6a 01                	push   $0x1
 ...
 126:	68 38 06 00 00       	push   $0x638
 12b:	e8 a0 00 00 00       	call   1d0 <strlen>
 130:	83 c4 0c             	add    $0xc,%esp
 133:	50                   	push   %eax
 134:	68 38 06 00 00       	push   $0x638
 139:	6a 01                	push   $0x1
...
free(void *ap)
{
 ...
 465:	a1 d0 08 00 00       	mov    0x8d0,%eax
{
 46a:	89 e5                	mov    %esp,%ebp
 46c:	57                   	push   %edi
 46d:	56                   	push   %esi
 46e:	53                   	push   %ebx
 46f:	8b 5d 08             	mov    0x8(%ebp),%ebx
 472:	8b 10                	mov    (%eax),%edx
  bp = (Header*)ap - 1;
 474:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 477:	39 c8                	cmp    %ecx,%eax
 479:	73 15                	jae    490 <free+0x30>
 47b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 47f:	90                   	nop
 480:	39 d1                	cmp    %edx,%ecx
 482:	72 14                	jb     498 <free+0x38>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 484:	39 d0                	cmp    %edx,%eax
 486:	73 10                	jae    498 <free+0x38>
{
 488:	89 d0                	mov    %edx,%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 48a:	8b 10                	mov    (%eax),%edx
 48c:	39 c8                	cmp    %ecx,%eax
 48e:	72 f0                	jb     480 <free+0x20>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 490:	39 d0                	cmp    %edx,%eax
 492:	72 f4                	jb     488 <free+0x28>
 494:	39 d1                	cmp    %edx,%ecx
 496:	73 f0                	jae    488 <free+0x28>
      break;
  if(bp + bp->s.size == p->s.ptr){
 498:	8b 73 fc             	mov    -0x4(%ebx),%esi
 49b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 49e:	39 fa                	cmp    %edi,%edx
 4a0:	74 1e                	je     4c0 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
 4a2:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
 4a5:	8b 50 04             	mov    0x4(%eax),%edx
 4a8:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 4ab:	39 f1                	cmp    %esi,%ecx
 4ad:	74 28                	je     4d7 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
 4af:	89 08                	mov    %ecx,(%eax)
  freep = p;
}
 4b1:	5b                   	pop    %ebx
  freep = p;
 4b2:	a3 d0 08 00 00       	mov    %eax,0x8d0
}
 4b7:	5e                   	pop    %esi
 4b8:	5f                   	pop    %edi
 4b9:	5d                   	pop    %ebp
 ...
 4bf:	90                   	nop
    bp->s.size += p->s.ptr->s.size;
 4c0:	03 72 04             	add    0x4(%edx),%esi
 4c3:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
 4c6:	8b 10                	mov    (%eax),%edx
 4c8:	8b 12                	mov    (%edx),%edx
 4ca:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
 4cd:	8b 50 04             	mov    0x4(%eax),%edx
 4d0:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 4d3:	39 f1                	cmp    %esi,%ecx
 4d5:	75 d8                	jne    4af <free+0x4f>
    p->s.size += bp->s.size;
 4d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 4da:	a3 d0 08 00 00       	mov    %eax,0x8d0
    p->s.size += bp->s.size;
 4df:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 4e2:	8b 53 f8             	mov    -0x8(%ebx),%edx
...
malloc(uint nbytes)
{
 ...
 4fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 500:	8b 3d d0 08 00 00    	mov    0x8d0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 506:	8d 70 07             	lea    0x7(%eax),%esi
 509:	c1 ee 03             	shr    $0x3,%esi
 50c:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
 50f:	85 ff                	test   %edi,%edi
 511:	0f 84 a9 00 00 00    	je     5c0 <malloc+0xd0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 517:	8b 07                	mov    (%edi),%eax
    if(p->s.size >= nunits){
 519:	8b 48 04             	mov    0x4(%eax),%ecx
 51c:	39 f1                	cmp    %esi,%ecx
 51e:	73 6d                	jae    58d <malloc+0x9d>
 520:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
 526:	bb 00 10 00 00       	mov    $0x1000,%ebx
 52b:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
 52e:	8d 0c dd 00 00 00 00 	lea    0x0(,%ebx,8),%ecx
 535:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
 538:	eb 17                	jmp    551 <malloc+0x61>
 53a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 540:	8b 10                	mov    (%eax),%edx
    if(p->s.size >= nunits){
 542:	8b 4a 04             	mov    0x4(%edx),%ecx
 545:	39 f1                	cmp    %esi,%ecx
 547:	73 4f                	jae    598 <malloc+0xa8>
 549:	8b 3d d0 08 00 00    	mov    0x8d0,%edi
 54f:	89 d0                	mov    %edx,%eax
    ...
    if(p == freep)
 551:	39 c7                	cmp    %eax,%edi
 553:	75 eb                	jne    540 <malloc+0x50>
  p = sbrk(nu * sizeof(Header));
 555:	83 ec 0c             	sub    $0xc,%esp
 558:	ff 75 e4             	pushl  -0x1c(%ebp)
 55b:	e8 db fe ff ff       	call   43b <sbrk>
  if(p == (char*)-1)
 560:	83 c4 10             	add    $0x10,%esp
 563:	83 f8 ff             	cmp    $0xffffffff,%eax
 566:	74 1b                	je     583 <malloc+0x93>
  hp->s.size = nu;
 ...
 571:	50                   	push   %eax
 572:	e8 e9 fe ff ff       	call   460 <free>
  return freep;
 577:	a1 d0 08 00 00       	mov    0x8d0,%eax
      if((p = morecore(nunits)) == 0)
 57c:	83 c4 10             	add    $0x10,%esp
 57f:	85 c0                	test   %eax,%eax
 581:	75 bd                	jne    540 <malloc+0x50>
        return 0;
  }
}
 ...
 59a:	74 54                	je     5f0 <malloc+0x100>
        p->s.size -= nunits;
 59c:	29 f1                	sub    %esi,%ecx
 59e:	89 4a 04             	mov    %ecx,0x4(%edx)
        p += p->s.size;
 5a1:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
        p->s.size = nunits;
 5a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 5a7:	a3 d0 08 00 00       	mov    %eax,0x8d0
}
 5ac:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
 5af:	8d 42 08             	lea    0x8(%edx),%eax
}
 5b2:	5b                   	pop    %ebx
 5b3:	5e                   	pop    %esi
 5b4:	5f                   	pop    %edi
 ...
 5be:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 5c0:	c7 05 d0 08 00 00 d4 	movl   $0x8d4,0x8d0
 5c7:	08 00 00 
    base.s.size = 0;
 5ca:	bf d4 08 00 00       	mov    $0x8d4,%edi
    base.s.ptr = freep = prevp = &base;
 5cf:	c7 05 d4 08 00 00 d4 	movl   $0x8d4,0x8d4
 5d6:	08 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 5d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 5db:	c7 05 d8 08 00 00 00 	movl   $0x0,0x8d8
 5e2:	00 00 00 
    if(p->s.size >= nunits){
 5e5:	e9 36 ff ff ff       	jmp    520 <malloc+0x30>
 5ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
 5f0:	8b 0a                	mov    (%edx),%ecx
 5f2:	89 08                	mov    %ecx,(%eax)
 5f4:	eb b1                	jmp    5a7 <malloc+0xb7>
